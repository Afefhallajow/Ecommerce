...
<td class="text-center"><a class="remove-from-cart" href="{{route('removeFromCart',$key)}}" data-toggle="tooltip" title="" data-original-title="Remove item"><i class="fa fa-trash"></i></a></td>
</tr>
@endforeach
</tbody>
</table>
...
<div class="column text-lg">Subtotal: <span class="tx-20 font-weight-bold mr-2">{{$price}}</span></div>
</div>
<div class="shopping-cart-footer">
<div class="column"><a class="btn btn-secondary" href="/market">Back to Shopping</a></div>
<div class="column"><a class="btn btn-primary" href="#" data-toast="" data-toast-type="success" data-toast-position="topRight" data-toast-icon="icon-circle-check" data-toast-title="Your cart" data-toast-message="is updated successfully!">Update Cart</a><a class="btn btn-success" href="{{route('stripe')}}">Checkout</a></div>
</div>
</div>
</div>
</div>
