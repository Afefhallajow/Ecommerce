...
<ul class="slide-menu">
<li><a class="slide-item" href="{{ route('market') }}">Products</a></li>
    <li><a class="slide-item" href="{{'/addproducts' }}">AddProduct</a></li>

    <li><a class="slide-item" href="{{'/' }}">Product-Details</a></li>
<li><a class="slide-item" href="{{ route('cart') }}">Cart</a></li>
</ul>
</li>
</ul>
</div>
